...
import { v as LoaderCircle, f as Building2, a1 as CircleCheck, b as Sparkles } from "../_libs/lucide-react.mjs";
...
const seedDemoBusiness = createServerFn({
  method: "POST"
}).middleware([requireSupabaseAuth]).handler(createSsrRpc("f5516b38bd74882f5b4ec7ccc3f701ec8a84581e6b00443a2b6899e65cc7a4a6"));
...
function BusinessPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-3xl px-6 py-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "mb-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5 flex flex-wrap items-center gap-3 rounded-lg border border-border/60 bg-card/40 p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-4 w-4 text-gold" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "flex-1 text-xs text-muted-foreground", children: "Want to walk the economic loop first? Load a demo cooperative with financials, an expansion plan, and compliance records already in your vault." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "button", variant: "outline", className: "border-gold/40", onClick: loadDemo, disabled: seeding, children: seeding ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-4 w-4 animate-spin" }) : "Load demo business" })
      ] })
    ] }),
